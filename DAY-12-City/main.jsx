...
class Box extends React.Component {
	...
	_handleKeyword(e) {
		if( e.target.value == "" )
			...
			var matchCity = city_name.filter( (c) => {
	...
	render() {
		var menu = this.state.matchArray.map( (val, index) => {
			return <div className="option" onClick={this.props.onClick.bind(this, val)} key={index}>{val}</div>;
		});

		return (
			<div className="box">
				<input type="text" placeholder="City" onChange={this._handleKeyword} />
				<div className="menu">
					{menu}
				</div>
			</div>
